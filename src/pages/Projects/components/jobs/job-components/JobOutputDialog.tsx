/**
 * Job Output Dialog Component
 * 
 * Dialog for displaying job output, including input and output content.
 * Provides navigation between multiple job outputs if available.
 */
