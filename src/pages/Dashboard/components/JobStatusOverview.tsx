...
const JobStatusOverview: React.FC<JobStatusOverviewProps> = ({ jobsData }) => {
  const totalJobs = jobsData.status.completed + jobsData.status.inProgress + jobsData.status.pending;
